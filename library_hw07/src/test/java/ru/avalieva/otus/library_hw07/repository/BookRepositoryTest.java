...
import ru.avalieva.otus.library_hw07.LibraryHw07Application;
...
@Import(LibraryHw07Application.class)
@DataJpaTest
public class BookRepositoryTest {
    ...
    public void addBookAuthorTestFailedUnknownAuthor() {
        ...
        Assertions.assertThrows(InvalidDataAccessApiUsageException.class, () -> { bookRepository.save(newBook); });
    }
