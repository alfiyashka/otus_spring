...
import ru.avalieva.otus.library_hw09_mvc.LibraryHw09MvcApplication;
...
import ru.avalieva.otus.library_hw09_mvc.repository.AuthorRepository;
import ru.avalieva.otus.library_hw09_mvc.repository.BookRepository;
import ru.avalieva.otus.library_hw09_mvc.repository.CommentRepository;
import ru.avalieva.otus.library_hw09_mvc.repository.GenreRepository;
...
@ContextConfiguration(classes = LibraryHw09MvcApplication.class)
@SpringBootTest
public class LibraryServiceTest {
    ...
    public void allGenresTest() {
        ...
        var result = libraryService.allGenres();
    ...
    public void allGenresTestFailed() {
        ...
        var error = Assertions.assertThrows(LibraryException.class, () -> { libraryService.allGenres(); });
    ...
    public void allBooksTest() {
        ...
        var result = libraryService.allBooks();
    ...
    public void allBooksTestFailed() {
        ...
        var error = Assertions.assertThrows(LibraryException.class, () -> { libraryService.allBooks(); });
        Assertions.assertEquals("Error", error.getMessage());
    ...
    public void allAuthorsTest() {
        ...
        var result = libraryService.allAuthors();
    ...
    public void allAuthorsTestFailed() {
        ...
        var error = Assertions.assertThrows(LibraryException.class, () -> { libraryService.allAuthors(); });
        Assertions.assertEquals("Error", error.getMessage());
    ...
    public void findBookByISBNTestFailed() {
        ...
        var error = Assertions.assertThrows(LibraryException.class, () -> { libraryService.findBookByISBN(1L); });
        Assertions.assertEquals("Error", error.getMessage());
    ...
    public void findBookByNameTest() {
        ...
        var result = libraryService.findBookByName(bookName);
        Assertions.assertEquals(books, result);
    ...
    public void findBookByNameTestFailed() {
        ...
        var error = Assertions.assertThrows(LibraryException.class, () -> { libraryService.findBookByName(bookName); });
        Assertions.assertEquals("Error", error.getMessage());
    ...
    public void findGenreByIdTest() {
        ...
        var result = libraryService.findGenreByID(genre.getId());
    ...
    public void findGenreByIdTestFailed() {
        ...
        var error = Assertions.assertThrows(LibraryException.class, () -> { libraryService.findGenreByID(id); });
        Assertions.assertEquals("Error", error.getMessage());
    ...
    public void findAuthorByIdTest() {
        ...
        var result = libraryService.findAuthorByID(author.getId());
    ...
    public void findAuthorByIdTestFailed() {
        ...
        var error = Assertions.assertThrows(LibraryException.class, () -> { libraryService.findAuthorByID(id); });
        Assertions.assertEquals("Error", error.getMessage());
    ...
    public void findCommentByBookTest() {
        ...
        var result = libraryService.findCommentByBookId(ISBN);
