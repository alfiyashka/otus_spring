package ru.avalieva.com.library_hw11_webflux.changelog;
...
public class MongoChangeLog {
    ...
    public void initBooks(MongoTemplate template){
        ...
        book2 = template.save(new Book(null, "Human Anatomy", 2018, author3 , genre2));
        ...
        template.save(new Book(null, "My Life 2", 1998, author4, genre6));
    }
    ...
    public void initComments(MongoTemplate template){
        ...
        template.save(new Comment(null, "More information", book2));
        template.save(new Comment(null, "Scientific", book2));
    }
}
